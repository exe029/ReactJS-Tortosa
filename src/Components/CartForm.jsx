...
const CartForm = () => {
  ...
  return (
    <>
        ...
        <>
         { 
            ...
            (<div className='flex flex-col items-center m-8 text-lg bg-gray-100 p-4 gap-4 mr-72 ml-72 rounded-md'>
              <p className='text-lg font-medium'>Tu compra se generó con el número de orden: </p>
              <h2 className='text-lg text-black font-semibold m-4 bg-gray-200 p-2 rounded-md hover:bg-blue-500 hover:text-white border-black hover:scale-110 duration-700'>{ orderNumber }</h2>

              <button className="button button-primary m-8 p-2 rounded-md border-solid border-2  font-semibold bg-violet-300 hover:bg-black hover:text-white border-black hover:scale-90 duration-700"
                onClick={cancelOrder}
      ...
      <h2 className='text-2xl p-8 capitalize'>Ingresa tus datos para terminar la compra</h2>
      <div className="">
        <label className='text-lg' htmlFor="">First Name: </label>
        <input className='rounded-md border-2 p-1 border-gray-500 m-2' type="text"
          name="fname"
          value={fname}
      ...
      <button type="submit" className="p-2 rounded-md border-solid border-2 m-8 font-semibold bg-violet-300 hover:bg-black hover:text-white border-black hover:scale-90 duration-700">Finalizar compra</button>
    </form>)
